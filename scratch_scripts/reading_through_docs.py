...
def fetch_coin_data_test(endpoints_obj):
    ...
    save_json(coin_data, '../data/bitcoin_data.json')
    print(coin_data)


def exchanges_list_test(endpoints_obj):
    endpoints_obj.set_all_exchanges()
    save_json(endpoints_obj.exchanges, '../data/exchanges.json')
...
def fetch_coin_exchange_tickers_test(endpoints_obj):
    ...
    save_json(coin_exchange_tickers, '../data/bitcoin_ticker.json')
...
def fetch_coin_recent_data_test(endpoints_obj):
    ...
    save_json(historic_data, '../data/bitcoin_recent_data.json')
    print(historic_data)
...
def fetch_coin_historic_data_test(endpoints_obj):
    ...
    save_json(historic_data, '../data/bitcoin_historic_data.json')
    print(historic_data)


def fetch_trending_test(endpoints_obj):
    trending_data = endpoints_obj.fetch_trending()
    save_json(trending_data, '../data/trending_data.json')
    print(trending_data)
